            ...
            <div>
                ...
                <div className='grid-container'>
                    ...
                    <div className='header-description'>
                        <h2>We make <a href='#' className='header-link'>Live</a>, <a href='#' className='header-link'>Push</a> and <a href='#' className='header-link'>Link</a> — unique software and hardware for music creation and performance. With these products, our community of users creates amazing things.We make Live, Push and Link — unique software and hardware for music creation and performance. With these products, our community of users creates amazing things.</h2>
